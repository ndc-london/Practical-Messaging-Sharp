...
namespace SimpleMessaging
{
    public class BadDataTypeChannelProducer<TActual, TIntended> : IDisposable where TActual: IAmAMessage where TIntended: IAmAMessage
    {
        ...
        public BadDataTypeChannelProducer(Func<TActual, string> messageSerializer, string hostName = "localhost")
        {
            ...
            _routingKey = typeof(TIntended).FullName;
            ...
            _channel.QueueBind(queue:queueName, exchange: ExchangeName, routingKey: _routingKey, arguments: arguments);
            ...
            _channel.ExchangeDeclare(InvalidMessageExchangeName, type: ExchangeType.Direct, durable: true);

            // TODO: declare an invalid message queue, durable
            _channel.QueueDeclare(invalidMessageQueueName, durable: true);
